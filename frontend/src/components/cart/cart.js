...
import cart, { showCart, updateQuantity, setCartState, removeCartProduct } from '../../redux/slices/cart';
import './cart.css'
                ...
                <div className="row">
                  <div className="d-flex justify-content-between">
                    ...
                    <div className="col-style col-2 quantity">
                      <button className="btn btn-primary fw-bold me-2" onClick={() => handleDecrement(item._id)}>-</button>
                      <input type="text"
                    ...
                    <div className="col-style col-1">{item.price * item.quantity}</div>
